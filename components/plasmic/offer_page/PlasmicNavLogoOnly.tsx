...
import sty from "./PlasmicNavLogoOnly.module.css"; // plasmic-import: RjVtVhV3oK9wFV/css
        ...
        {(hasVariant(globalVariants, "screen", "mobileOnly") ? true : true) ? (
          ...
          >
            {(
              ...
              <div className={classNames(projectcss.all, sty.column__u3NmG)} />
            ) : null}
            <div className={classNames(projectcss.all, sty.column__nZUs)}>
              <p.PlasmicLink
            ...
            {(
              ...
              <div className={classNames(projectcss.all, sty.column__unEl)} />
            ) : null}
          </div>
        ) : null}
      </div>

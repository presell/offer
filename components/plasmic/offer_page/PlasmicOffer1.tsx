...
import sty from "./PlasmicOffer1.module.css"; // plasmic-import: wWyw3gA_WCKGRp/css
...
function PlasmicOffer1__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___5UcTf)}>
        <div className={classNames(projectcss.all, sty.freeBox__bPuB0)}>
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.PlasmicImg
                alt={""}
                className={classNames(sty.img__pDbnn)}
                ...
                src={{
                  src: "/plasmic/offer_page/images/offersvg.svg",
                  fullWidth: 76,
                  fullHeight: 150,
      ...
      <div className={classNames(projectcss.all, sty.freeBox__fwY0)}>
        <div
        ...
        <div className={classNames(projectcss.all, sty.freeBox___29AAx)}>
          {p.renderPlasmicSlot({
            defaultContents:
        ...
        <div className={classNames(projectcss.all, sty.freeBox__n6K1H)}>
          {p.renderPlasmicSlot({
        ...
        <div className={classNames(projectcss.all, sty.freeBox__oh1Wo)}>
          <div className={classNames(projectcss.all, sty.freeBox__r8Dq1)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img___2NkAw)}
          ...
          <div className={classNames(projectcss.all, sty.freeBox__mDftn)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__unbY0)}
                    displayHeight={"60px" as const}
                    displayMaxHeight={"none" as const}
                    displayMaxWidth={"100%" as const}
                    displayMinHeight={"0" as const}

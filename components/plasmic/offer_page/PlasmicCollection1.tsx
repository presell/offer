...
import sty from "./PlasmicCollection1.module.css"; // plasmic-import: gNux8a0n6tyhXq/css
...
function PlasmicCollection1__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__eRtC8)}>
        {p.renderPlasmicSlot({
          defaultContents: (
            <p.PlasmicImg
              alt={""}
              className={classNames(sty.img__o6Odi)}
              ...
              src={{
                src: "/plasmic/offer_page/images/productVariety1C2E7Bd9Ac9C4989Bfad811526Dad7E0250X2502Xjpgpng.png",
                fullWidth: 387,
                fullHeight: 442,
      ...
      <div className={classNames(projectcss.all, sty.freeBox__dw6C)}>
        {p.renderPlasmicSlot({
      ...
      <div className={classNames(projectcss.all, sty.freeBox__qrxNv)}>
        {p.renderPlasmicSlot({
          defaultContents: "★★★★★ (447)",
          value: args.slot2,
      ...
      <div className={classNames(projectcss.all, sty.freeBox__miJdl)}>
        {p.renderPlasmicSlot({
      ...
      <div className={classNames(projectcss.all, sty.freeBox___2Gtii)}>
        {p.renderPlasmicSlot({
      ...
      <div className={classNames(projectcss.all, sty.freeBox__j7Fnk)}>
        {p.renderPlasmicSlot({
      ...
      >
        <div className={classNames(projectcss.all, sty.column__ihtZ)}>
          <div className={classNames(projectcss.all, sty.freeBox__sgFi5)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <p.PlasmicImg
                  alt={""}
                  className={classNames(sty.img__szbU)}
                  ...
                  loading={"lazy" as const}
                  src={{
                    src: "/plasmic/offer_page/images/labelsvg.svg",
                    fullWidth: 150,
                    fullHeight: 150,
                    aspectRatio: 1
                  }}
            ...
            <div className={classNames(projectcss.all, sty.freeBox__y3Kv)}>
              {p.renderPlasmicSlot({
        ...
        <div className={classNames(projectcss.all, sty.column__jwrIg)}>
          <div className={classNames(projectcss.all, sty.freeBox__pfPd4)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <p.PlasmicImg
                  alt={""}
                  className={classNames(sty.img___55XNs)}
                  displayHeight={"auto" as const}
                  displayMaxHeight={"none" as const}
                  displayMaxWidth={"100%" as const}
                  displayMinHeight={"0" as const}
                  ...
                  loading={"lazy" as const}
                  src={{
                    src: "/plasmic/offer_page/images/labelsvg2.svg",
                    fullWidth: 150,
                    fullHeight: 150,
                    aspectRatio: 1
                  }}
            ...
            <div className={classNames(projectcss.all, sty.freeBox__kVbBw)}>
              {p.renderPlasmicSlot({

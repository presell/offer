...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: Sy09CMDKU8HXB/css

import ChevronRightIcon from "./icons/PlasmicIcon__ChevronRight"; // plasmic-import: t3zzP6bVzu6wUF/icon
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__hHmm7)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__sjASb)}
                role={"img"}
              />
            ),

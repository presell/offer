...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: YSHTZQGlCYa4ed/css
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__r1VI)}
                role={"img"}
              />
            ),

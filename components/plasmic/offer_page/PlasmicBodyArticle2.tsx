...
import sty from "./PlasmicBodyArticle2.module.css"; // plasmic-import: 7FOSttZv5XFufa/css
...
function PlasmicBodyArticle2__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__fbgNd)}
        component={Link}
        href={(() => {
          try {
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__syj5V)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__p8Fw6)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__tnlhe)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__sf9TQ)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__j5Kt9)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__m5DPk)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      {(hasVariant(globalVariants, "screen", "mobileOnly") ? true : true) ? (
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.column__nOd3R)}>
              <p.PlasmicLink
                className={classNames(
                  projectcss.all,
                  projectcss.a,
            ...
            <div className={classNames(projectcss.all, sty.column__spO0)}>
              <p.PlasmicImg
                alt={""}
                className={classNames(sty.img__b5OA3)}
                displayHeight={
                  hasVariant(globalVariants, "screen", "mobileOnly")
                    ? ("70%" as const)
                    : ("80%" as const)
            ...
            <div className={classNames(projectcss.all, sty.column___5TjKl)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <p.PlasmicImg
                alt={""}
                className={classNames(sty.img__q3PBs)}
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__duf8I)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];

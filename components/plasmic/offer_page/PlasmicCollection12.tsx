...
import sty from "./PlasmicCollection12.module.css"; // plasmic-import: C3-7XbqAWJS0jS/css
...
function PlasmicCollection12__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__pDpyI)}>
        {p.renderPlasmicSlot({
          defaultContents: (
            <p.PlasmicImg
              alt={""}
              className={classNames(sty.img__d4QdK)}
      ...
      <div className={classNames(projectcss.all, sty.freeBox___2Ih5)}>
        {p.renderPlasmicSlot({
      ...
      <div className={classNames(projectcss.all, sty.freeBox___4BsEw)}>
        {p.renderPlasmicSlot({
          defaultContents: "★★★★★ (447)",
          value: args.slot2,
      ...
      <div className={classNames(projectcss.all, sty.freeBox__f80VL)}>
        {p.renderPlasmicSlot({
      ...
      <div className={classNames(projectcss.all, sty.freeBox__xEjcn)}>
        {p.renderPlasmicSlot({
